...
angular.module('fiona').controller('BackstorageController', function($scope, $controller) {
    ...
    $scope.backstoragedetailsportal = {
        master: {
            id: "backstoragedetails",
    ...
    $controller('BasePortalController', {$scope: $scope, component: $scope.backstoragedetailsportal}); //继承
    ...
    $scope.productportal = {
        ...
        master: {
            ...
            submit: function (selected) {
                $scope.backstoragedetailss = selected;
            }
        },

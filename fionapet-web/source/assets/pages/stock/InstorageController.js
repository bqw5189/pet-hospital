...
angular.module('fiona').controller('InstorageController', function($scope, $controller, $http, commons) {
    ...
    $controller('BasePortalController', {$scope: $scope, component: $scope.instoragedetailsportal}); //继承
    ...
    $scope.productportal = {
        ...
        master: {
            ...
            submit: function (selected) {
                $scope.instoragedetailss = selected;
            }
        },
    ...
    $scope.master.update = function () {
        ...
        $scope.instoragedetails.search($scope.instorage.id);
    };
});